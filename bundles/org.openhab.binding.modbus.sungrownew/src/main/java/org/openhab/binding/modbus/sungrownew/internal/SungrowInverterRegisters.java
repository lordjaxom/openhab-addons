 ...
 */
package org.openhab.binding.modbus.sungrownew.internal;
...
public enum SungrowInverterRegisters {
    ...
    BATTERY_POWER(5214, INT32_SWAP, BigDecimal.ONE, quantityFactory(Units.WATT), "battery-information"),
    ...
    RUNNING_STATE(13001, UINT16, BigDecimal.ONE, quantityFactory(Units.ONE), "overview"),
    ...
    BATTERY_CURRENT(13021, UINT16, ConversionConstants.DIV_BY_TEN, quantityFactory(Units.AMPERE),
            "battery-information"),
    // Moved to registers 5214-5215
    // BATTERY_POWER(13022, INT16, BigDecimal.ONE, quantityFactory(Units.WATT), "battery-information"),
