...
- `sungrow-inverter-new`: The sungrow inverter
...
### Sungrow Inverter (`sungrow-inverter-new`)
...
The `sungrow-inverter-new` thing has channels that serve the current state of the sungrow inverter, as you are used to from the iSolareCloud Website and App.
...
Bridge modbus:tcp:sungrowBridge [ host="10.0.0.2", port=502, id=1, enableDiscovery=false ] {
    Thing sungrow-inverter-new sungrowInverter "Sungrow Inverter" [ pollInterval=5000 ]
}
```
